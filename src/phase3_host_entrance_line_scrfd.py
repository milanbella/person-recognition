...
from phase2_host_tracking_scrfd import (
    Detection,
    SimpleIoUTracker,
    Track,
    build_argparser as build_tracking_argparser,
    draw_tracks,
)
...
def build_argparser() -> argparse.ArgumentParser:
    parser = build_tracking_argparser()
    parser.description = "Step 6: host-side entrance-line logic on top of SCRFD tracking."
    parser.add_argument(
        "--line-axis",
        choices=["x", "y"],
        default="x",
